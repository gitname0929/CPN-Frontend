  ...
  <div id="bottomRight">
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="fs-xl text mx-2" style="font-size: medium">算力地图</span>
          <div class="decoration2">
            <dv-decoration-2
              :reverse="true"
              style="width: 5px; height: 330px"
            />
          </div>
        </div>
      </div>
      <div>
        <!-- <bottomRightChart /> -->
        <centerMapChart ref="CenterMapChart" @parent-event="RefreshSelect"/>
      </div>
    </div>
  </div>
</template>
...
import centerMapChart from "@/components/echart/center/centerMapChart.vue";
export default {
  data() {
    return {};
  },
  ...
  methods: {
    ...
    async fetchProposalSubmit() {
      ...
      //   }
      //   this.$refs.CenterMapChart.refresh(resultList);
      // }
    },
    RefreshSelect(selectCity, cityIndex) {
      this.$emit('parent-event', selectCity, cityIndex);
    }
  },
};
</script>
